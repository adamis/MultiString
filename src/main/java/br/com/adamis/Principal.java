...
import br.com.adamis.formater.SQLFormatter;
...
public class Principal extends JFrame {
	...
	public Principal() {
		...
		setTitle("StringFicador Version: 1.4 b");
		...
		btnPretty.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				String formattedSQL = new SQLFormatter().format(tAInput.getText());
				tAInput.setText(formattedSQL);
			}
		});
